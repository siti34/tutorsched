...
import { TrendingUp, DollarSign, ChevronRight, CheckCircle } from "lucide-react";
...
export default function BillingClient({ overview }: Props) {
  ...
  return (
    <div>
      <div className="mb-5">
        <h1 className="text-2xl font-bold text-khan-navy">Billing</h1>
        <p className="text-sm text-muted-foreground">{overview.month}</p>
      </div>

      {/* Summary */}
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="bg-khan-navy rounded-2xl p-4 text-white">
        ...
        <div className="bg-white border border-border rounded-2xl p-4">
          <div className="flex items-center gap-1.5 mb-2">
            <DollarSign size={13} className="text-sun-500" />
            <span className="text-xs font-semibold text-muted-foreground">Pending</span>
          </div>
          <p className="text-2xl font-bold text-khan-navy">S${overview.pendingTotal.toFixed(0)}</p>
            ...
            <div key={s.studentId} className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs font-bold text-khan-navy">
                    S${s.total.toFixed(0)}
                  </span>
                </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-khan-navy font-semibold text-sm">{s.studentName}</p>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <div className="text-right">
                    <p className="text-khan-navy font-bold text-sm">S${s.total.toFixed(0)}</p>
              ...
              {!isPaid && (
                <button
                  ...
                  className="mt-3 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-teal-200 text-teal-600 text-xs font-bold hover:bg-teal-50 transition-colors disabled:opacity-50 cursor-pointer"
                >
